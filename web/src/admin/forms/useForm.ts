 ...
 *
 * Responsibilities / 职责:
 *   - Hold form field values in React state.
 *   - Run field-scoped validator functions on submit.
 ...
 * @param validators - Optional map of field validators.
 *
 * initial 是表单初始值.
 * validators 是可选的字段校验函数映射.
 *
