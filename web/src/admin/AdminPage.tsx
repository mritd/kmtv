 ...
 *
 * The page-level source and subscription queries populate the summary grid. Each panel
 * owns its own query state so its loading and error UI remains independent.
 *
 * 页面级源和订阅查询填充汇总统计. 每个面板维护自己的查询状态,
 * 因此加载和错误 UI 互不影响.
 */
export function AdminPage() {
  ...
  // The null guard also keeps this handler safe if authentication changes before the click.
  //
  // 为当前登录用户打开修改密码弹窗.
  // 空值保护也能处理点击前认证状态发生变化的情况.
